...
namespace SP
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        {
            MessageBox.Show("Requeni, Gonzalo");
        }
        ...
        private void btnPunto3_Click(object sender, EventArgs e)
        {
            ...
            if (this._manzana.Xml(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\manzana.xml"))
            {
            ...
            if (((IDeserializar)this._manzana).Xml(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\manzana.xml", out aux))
            {
            ...
            if (this.c_manzanas.Xml(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\manzanas.xml"))
            {
